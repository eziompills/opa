...
<li class="nav-item"><a class="nav-link" href="/pro.php">Pour les pros</a></li>
<li class="nav-item"><a class="nav-link" href="/blog/index.php">Blog</a></li>
        ...
        <?php endif; ?>
        <?php if(is_logged()): ?>
            <li class="nav-item"><a class="nav-link" href="/my_bookings.php">Mes réservations</a></li>
...
<li class="nav-item">
  <button id="themeToggle" class="btn btn-link nav-link"><i class="bi-moon"></i></button>
</li>
</ul>
    </div>
  </div>
